...
public class WPILOGBackgroundWriter implements LogDataReceiver {

  // Copied from org.littletonrobotics.junction.wpilog.WPILOGConstants
  ...
  /**
   * Create a new WPILOGBackgroundWriter for writing to a ".wpilog" file.
   *
   ...
   *                     AdvantageScope.
   */
  public WPILOGBackgroundWriter(String path, AdvantageScopeOpenBehavior openBehavior) {
   ...
   */
  public WPILOGBackgroundWriter(String path) {
   ...
   *                     AdvantageScope.
   */
  public WPILOGBackgroundWriter(AdvantageScopeOpenBehavior openBehavior) {
  ...
  public void start() {
    ...
    log = new DataLogBackgroundWriter(folder, filename, 0.25 /* default in seconds */, WPILOGConstants.extraHeader);
    isOpen = true;
