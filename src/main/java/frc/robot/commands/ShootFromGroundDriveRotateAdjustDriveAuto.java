...
public class ShootFromGroundDriveRotateAdjustDriveAuto extends SequentialCommandGroup {
  DrivebaseSubsystem m_drivebase;
  ShooterSubsystem m_shooter;
  IntakeSubsystem m_intake;
  LedSubsystem m_led;

  public ShootFromGroundDriveRotateAdjustDriveAuto(ShooterSubsystem shooter, IntakeSubsystem intake, LedSubsystem led,
      DrivebaseSubsystem drivebase, double angle, double drivelengthangle, double offset) {
    m_shooter = shooter;
    m_intake = intake;
    m_led = led;
