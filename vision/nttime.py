...
def main():
    ...
    print('datetime.now        time.mono         time.time         evt-time         d1          d2       value server-time  d3')
    while True:
        enable = True
        time.sleep(1)
        if times:
            ...
            print(f'{now.time()} {mono:13.6f} {ttime:17.6f} {evttime/1e6:17.6f} {d1:10.6f} {d2:10.6f} {value:11} {stime:11}  {value-stime}')
